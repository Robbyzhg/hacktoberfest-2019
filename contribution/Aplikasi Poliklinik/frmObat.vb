...
Public Class frmObat
    ...
    Private Sub cekdata()
        ...
        comm.CommandText = "SELECT * FROM tblObat"
        ...
        Else
            ...
            dgdata.Columns(1).HeaderText = "Merk Obat"
            dgdata.Columns(2).HeaderText = "Satuan Obat"
            dgdata.Columns(3).HeaderText = "Harga"
    ...
    Private Sub isilbl()
        Try
            ...
            lblJK.Text = dgdata.CurrentRow.Cells(2).Value
    ...
    Private Sub cmdInsert_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles cmdInsert.Click
        ...
        comm = New OleDbCommand
        comm.Connection = conn
        comm.CommandText = "SELECT idObat FROM tblObat ORDER BY idObat DESC"
        reader = comm.ExecuteReader
        If reader.HasRows = False Then
            lblID.Text = "1"
        Else
    ...
    Private Sub cmdConfirm_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdConfirm.Click
        If validasi() = True Then
            ...
            comm.Connection = conn
            If func = "I" Then
                comm.CommandText = "INSERT INTO tblObat VALUES (@id, @nama, @jk, @telp)"
                ...
                End With
            Else
                comm.CommandText = "UPDATE tblObat SET merk = @nama, harga = @telp, satuan = @jk WHERE idObat = @id"
                With comm.Parameters
                    .Add(pnama)
                    .Add(ptelp)
                    .Add(pjk)
